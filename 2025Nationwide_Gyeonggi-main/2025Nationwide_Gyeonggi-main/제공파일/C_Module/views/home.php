  ...
  <div class="container">
    ...
    <div class="sideBar">
      <ul>
        <li><a href="#visual">비주얼</a></li>
        <li><a href="#sogea">소개</a></li>
        <li><a href="#bookList">도서목록</a></li>
        <li><a href="#rules">이용수칙</a></li>
      </ul>
    </div>
    
    <main>
      <div class="slideBox" id="visual">
        <ul>
          <li><img src="./img/slideImg/slide1.png" alt="slide" title="slide1">
            <div class="slideTxt h100vh flex aic fff">
              <p class="txtAnimation1">Lorem ipsum dolor sit amet,consectetur</p>
            </div>
          </li>
          <li><img src="./img/slideImg/slide2.png" alt="slide" title="slide2">
            <div class="slideTxt h100vh flex aic fff">
              <p class="txtAnimation2">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</p>
            </div>
          </li>
          <li><img src="./img/slideImg/slide3.png" alt="slide" title="slide3">
            <div class="slideTxt h100vh flex aic fff">
              <p class="txtAnimation3">Lorem ipsum dolor sit, ametconsectetur adipisicing.</p>
            </div>
          </li>
          <li><img src="./img/slideImg/slide1.png" alt="slide" title="slide4">
            <div class="slideTxt h100vh flex aic fff">
              <p class="txtAnimation1">Lorem ipsum dolor sit amet,consectetur</p>
            </div>
          </li>
      ...
      <div class="centerBox m0a w1750" id="sogea">
        <section class="introductionPage">
          <div class="contentB">
            <div class="contentImg">
              <img src="./공통제공파일/image/3.jpg" alt="sogea" title="sogea">
              <ul class="sogeaTxt">
                <li>별처럼 반짝이는 지식의 공간, 광주시립 별빛도서관</li>
                <li>광주시립 별빛도서관은 시민 누구나 지식과 문화를 자유롭게 누릴 수 있는 열린 공간입니다.</li>
                <li>북구 용봉로에 자리한 이곳은 아늑하고 현대적인 시설과 함께 다양한 장르의 도서, 전자자료, 멀티미디어 자료를 갖추고 있으며, 어린이부터 어르신까지 모든 세대를 위한 맞춤형 독서·문화 프로그램을 운영하고 있습니다.</li>
                <li>‘별빛’이라는 이름처럼, 어둠 속 길잡이 별이 되어주는 도서관.</li>
                <li>광주시립 별빛도서관은 여러분의 삶에 지식의 빛과 쉼의 여유를 더해드립니다.</li>
              </ul>
            </div>
          </div>
        </section>
        
        <section class="library" id="bookList">
          <div class="ctlBox">
            <input type="number" min="4" max="4" placeholder="3" id="alignInput">
            <div class="AscDesc">
                <input type="radio" name="adesc" id="asc" class="ascBtn" hidden>
                <label for="asc">ASC</label>
                <input type="radio" name="adesc" id="desc" class="descBtn" hidden checked>
                <label for="desc">DESC</label>
            </div>
          </div>
          
          <ul class="ascList">
            <li><img src="./제공 이미지/books/고마워, 한글.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/참나무 숲 장수풍뎅이.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/조금만 참으렴.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/봄 여름 이야기.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/기차를 타고 창 밖을 봐요.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/금붕어의 어항 일기.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/버스 타고 지하철 타고 아빠에게 가요.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/나를 찾아 줘!.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/정말 멋진 선물이야.jpg" alt="book" title="book"></li>
            <li><img src="./제공 이미지/books/자동차 타는 여우.jpg" alt="book" title="book"></li>
          </ul>
        ...
        <div class="useRule" id="rules">
          <ul>
            <li>도서관 내에서는 대화 및 통화는 자제해 주시고, 정숙한 분위기를 유지해 주세요.</li>
            <li>도서관의 책, 컴퓨터, 가구 등 모든 시설은 공공자산입니다. 임의로 훼손하거나 낙서하지 마세요.</li>
            <li>도서는 정해진 기간 내 반납해야 하며, 연체 시에는 대출 제한 등의 불이익이 있을 수 있습니다.</li>
            <li>이어폰 미사용 음향 재생, 자리 맡기기, 좌석 독점 등 타인의 이용을 방해하는 행위는 삼가주세요.</li>
          </ul>
        </div>
        ...
        <div class="application tac">
          ...
          <div class="flexBox">
            <span class="dateAndLR">
              <a href="#">&lt;</a><span>2025년</span><a href="#">&gt;</a>
            </span>

            <div class="monthBox">
              <div class="month">
                <input type="radio" name="m" id="m1" checked hidden>
                <label for="m1">1월</label>

                <input type="radio" name="m" id="m2" hidden>
                <label for="m22">2월</label>

                <input type="radio" name="m" id="m3" hidden>
                <label for="m33">3월</label>

                <input type="radio" name="m" id="m4" hidden>
                <label for="m4">4월</label>

                <input type="radio" name="m" id="m5" hidden>
                <label for="m5">5월</label>

                <input type="radio" name="m" id="m6" hidden>
                <label for="m6">6월</label>

                <input type="radio" name="m" id="m7" hidden>
                <label for="m7">7월</label>

                <input type="radio" name="m" id="m8" hidden>
                <label for="m88">8월</label>

                <input type="radio" name="m" id="m9" hidden>
                <label for="m9">9월</label>

                <input type="radio" name="m" id="m10" hidden>
                <label for="m1010">10월</label>

                <input type="radio" name="m" id="m11" hidden>
                <label for="m1111">11월</label>

                <input type="radio" name="m" id="m12" hidden>
                <label for="m1212">12월</label>
              </div>
            </div>

            <div class="monthEvent">
              <div class="month1">
                <ul class="eventBox1 eb">
                  <li class="title">내가 쓰는 MBTI 왕조실록</li>
                  <li class="content">운암도서관</li>
                  <li class="place">운암도서관</li>
                  <li class="date">2025-01-14 ~ 2025-01-17</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
              </div>
              
              <div class="month4">
                <ul class="eventBox2 eb">
                  <li class="title">도서관주관 & 책의날 행사</li>
                  <li class="content">광주광역시립무등도서관</li>
                  <li class="place">광주광역시립무등도서관</li>
                  <li class="date">2025-04-12 ~ 2025-04-25</li>
                  <li><a href="#">신청하기</a></li>
                </ul>

                <ul class="eventBox3 eb">
                  <li class="title">문학이 온다</li>
                  <li class="content">광주광역시립도서관</li>
                  <li class="place">광주광역시청 야외광장</li>
                  <li class="date">2025-04-05 ~ 2025-04-05</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
                
                <ul class="eventBox4 eb">
                  <li class="title">꿈을 키우는 씨앗 도서관에 묻다</li>
                  <li class="content">광산구립도서관</li>
                  <li class="place">광산구립도서관</li>
                  <li class="date">2025-04-11 ~ 2025-04-20</li>
                  <li><a href="#">신청하기</a></li>
                </ul>

                <ul class="eventBox5 eb">
                  <li class="title">백수린 작가와의 만남</li>
                  <li class="content">광주광역시립무등도서관 </li>
                  <li class="place">광주광역시립무등도서관 대회의실(1층)</li>
                  <li class="date">2025-04-18 ~ 2025-04-18</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
              </div>
              ...
              <div class="month5">
                ...
                <ul class="eventBox7 eb">
                  <li class="title">어린이날 특별행사 안내</li>
                  <li class="content">산수도서관</li>
                  <li class="place">산수도서관</li>
                  <li class="date">2025-05-03 ~ 2025-05-04</li>
                  <li><a href="#">신청하기</a></li>
                </ul>

                <ul class="eventBox8 eb">
                  <li class="title">달빛 야외 도서관</li>
                  <li class="content">가오도서관</li>
                  <li class="place">동구청 중앙광장</li>
                  <li class="date">2025-05-23 ~ 2025-05-24</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
              </div>

              <div class="month57">
                <ul class="eventBox6 eb">
                  <li class="title">광주의 문학과 영화</li>
                  <li class="content">광주광역시립도서관</li>
                  <li class="place">광주광역시립도서관</li>
                  <li class="date">2025-05-23 ~ 2025-07-04</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
              </div>

              <div class="month9">
                <ul class="eventBox9 eb">
                  <li class="title">갑진 독서</li>
                  <li class="content">광주광역시립도서관</li>
                  <li class="place">광주광역시청 앞 광장</li>
                  <li class="date">2025-09-02 ~ 2025-09-23</li>
                  <li><a href="#">신청하기</a></li>
                </ul>
              </div>
